export class ModDataTree {
    ...
    constructor(input) {
        ...
        const { component: closeBtn, } =
            Shared.createHTMLComponent({ tag: 'button', class: 'base-mod-data-tree-close', parent: buttonContainer, });
    ...
    highlightText(input) {
        ...
        const highlightText = text.replace(regex, '<span class="base-mod-data-tree-highlight-search">$1</span>');
