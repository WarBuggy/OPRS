window.translatableTexts = {
    en: {
        ...
        mapMainCanvasNotFound: 'Cannot find canvas with id "{canvasId}".',
        mapMainInvalidTilePerInch: `Invalid number of tiles per inch: expected positive integer, got {value}.`,
        mapMainInvalidMapWidthInInch: `Invalid input map width: expected positive integer, got {value}.`,
        mapMainInvalidMapWidthInInch: `Invalid input map height: expected positive integer, got {value}.`,
        mapMainInvalidDisplayMode: `Invalide display mode "{mode}".`,
        mapMainNoDefaultZoomLevelFound: `No default zoom level found for display mode "{mode}".`,
        mapMainNoDefaultZoomLevelDataFound: `Default zoom level contains no data for display mode "{mode}".`,
        mapMainnoZoomInStorage: `No zoom level found in local storage.`,
        mapMainFallBackToDefaultZoomLevel: `Falling back to default zoom level.`,
        mapMainNoZoomLevelDataFound: `Mode {mode} does not have zoom level {zoomLevel}.`,
